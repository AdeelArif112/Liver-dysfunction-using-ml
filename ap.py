...
st.markdown("""# **Wellcome to Liver dysfunction Detection System**""")
...
def predict_disease(Gender, age, Total_Bilirubin, Direct_Bilirubin, Alkphos_Alkaline_Phosphotase, Sgpt_Alamine_Aminotransferase, Sgot_Aspartate_Aminotransferase, Total_Protiens,
    ...
    if prediction is not None:
        result = "Positive ( Consult health care for further diagnostic)" if prediction == 1 else "Negative (No need for further diagnostics unless  you have severe symptoms)"
    else:
